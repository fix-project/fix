...
if (DEFINED CLANG_FORMAT)
    ...
    file (GLOB_RECURSE ALL_FLATWARE_FILES ${CMAKE_CURRENT_SOURCE_DIR}/flatware/*.c)
    add_custom_target (format ${CLANG_FORMAT} -i ${ALL_CC_FILES} ${ALL_HH_FILES} ${ALL_BENCHMARK_FILES} ${ALL_FLATWARE_FILES} COMMENT "Formatted all source files.")
