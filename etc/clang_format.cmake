...
if (DEFINED CLANG_FORMAT)
    ...
    file (GLOB_RECURSE ALL_CC_FILES ${CMAKE_CURRENT_SOURCE_DIR}/src/*.c)
    file (GLOB_RECURSE ALL_HH_FILES ${CMAKE_CURRENT_SOURCE_DIR}/src/*.h)
    add_custom_target (flatware-format ${CLANG_FORMAT} -i ${ALL_CC_FILES} ${ALL_HH_FILES} COMMENT "Formatted all source files.")
else (NOT DEFINED CLANG_FORMAT)
    add_custom_target (flatware-format echo "Could not find clang-format. Please install and re-run cmake")
