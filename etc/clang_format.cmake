...
if (DEFINED CLANG_FORMAT)
    ...
    add_custom_target (fixpoint-format ${CLANG_FORMAT} -i ${ALL_CC_FILES} ${ALL_HH_FILES} ${ALL_BENCHMARK_FILES} COMMENT "Formatted all source files.")
else (NOT DEFINED CLANG_FORMAT)
    add_custom_target (fixpoint-format echo "Could not find clang-format. Please install and re-run cmake")
