...
C_DESCRIPTION = f' Imports wasm tables, memories, and helper functions from \
                    "{MODULE}" and imports fixpoint api functions.'
...
C_SIZE = 'int32_t size_{name}() __attribute__( ( import_module( "{module}" ),\
...
C_GET_ATTACHED = 'externref get_attached_{tree_or_blob}_{name}()\n\
...
C_MEM_GROW = 'int32_t grow_{name}( int32_t size )\n\
  __attribute__( ( import_module( "{module}" ), import_name( "grow_{name}" ) ) );\n'
...
# c function lists
C_LIST_TABLE_GET = 'externref (*get_{ro_or_rw}_table_functions[]) (int32_t) = {list};\n'
C_LIST_TABLE_SET = 'void (*set_rw_table_functions[]) (int32_t, externref) = {list};\n'
C_LIST_TABLE_GROW = 'int32_t (*grow_rw_table_functions[]) (int32_t, externref) = {list};\n'
C_LIST_MEM_GET = 'int32_t (*get_{int_type}_{ro_or_rw}_mem_functions[]) (int32_t) = {list};\n'
C_LIST_MEM_SET = 'void (*set_{int_type}_rw_mem_functions[]) (int32_t, int32_t) = {list};\n'
C_LIST_MEM_GROW = 'int32_t (*grow_rw_mem_functions[]) (int32_t) = {list};\n'
C_LIST_SIZE = 'int32_t (*size_{ro_or_rw}_{mem_or_table}_functions[])(void) = {list};\n'
C_LIST_CREATE = 'externref (*create_{tree_or_blob}_functions[]) (int32_t) = {list};\n'
C_LIST_GET_ATTACHED = 'externref (*get_attached_{tree_or_blob}_functions[]) (void) = {list};\n'
C_LIST_ATTACH = 'void (*attach_{tree_or_blob}_functions[]) (externref) = {list};\n'
...
def write_c():
    ...
    f.write(f'const int NUM_RO_MEM = {NUM_RO_MEM};\n')
    f.write(f'const int NUM_RO_TABLE = {NUM_RO_TABLE};\n')
    f.write(f'const int NUM_RW_MEM = {NUM_RW_MEM};\n')
    f.write(f'const int NUM_RW_TABLE = {NUM_RW_TABLE};\n')
    f.write('\n')
    ...
    f_list = ','.join([f'attach_tree_ro_table_{i}' for i in range(NUM_RO_MEM) ])
