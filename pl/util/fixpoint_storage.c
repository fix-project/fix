...
const int NUM_RO_MEM = 3;
const int NUM_RO_TABLE = 3;
const int NUM_RW_MEM = 3;
const int NUM_RW_TABLE = 3;

// ro_table_0 imports 
externref get_ro_table_0( int32_t index )
  __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_ro_table_0" ) ) )
;int32_t size_ro_table_0() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_ro_table_0" ) ) );
void attach_tree_ro_table_0(externref)
  __attribute__( ( import_module( "fixpoint" ), import_name( "attach_tree_ro_table_0" ) ) );
externref get_attached_tree_ro_table_0()
...
;int32_t size_ro_table_1() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_ro_table_1" ) ) );
void attach_tree_ro_table_1(externref)
  __attribute__( ( import_module( "fixpoint" ), import_name( "attach_tree_ro_table_1" ) ) );
externref get_attached_tree_ro_table_1()
...
;int32_t size_ro_table_2() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_ro_table_2" ) ) );
void attach_tree_ro_table_2(externref)
  __attribute__( ( import_module( "fixpoint" ), import_name( "attach_tree_ro_table_2" ) ) );
externref get_attached_tree_ro_table_2()
...
int32_t size_rw_table_0() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_rw_table_0" ) ) );
...
int32_t size_rw_table_1() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_rw_table_1" ) ) );
...
int32_t size_rw_table_2() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_rw_table_2" ) ) );
...
int32_t size_ro_mem_0() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_ro_mem_0" ) ) );
externref get_attached_blob_ro_mem_0()
...
int32_t size_ro_mem_1() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_ro_mem_1" ) ) );
externref get_attached_blob_ro_mem_1()
...
int32_t size_ro_mem_2() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_ro_mem_2" ) ) );
externref get_attached_blob_ro_mem_2()
...
int32_t size_rw_mem_0() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_rw_mem_0" ) ) );
...
int32_t size_rw_mem_1() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_rw_mem_1" ) ) );
...
int32_t size_rw_mem_2() __attribute__( ( import_module( "fixpoint_storage" ),             import_name( "size_rw_mem_2" ) ) );
...
externref (*get_ro_table_functions[]) (int32_t) = {get_ro_table_0,get_ro_table_1,get_ro_table_2};
int32_t (*size_ro_table_functions[])(void) = {size_ro_table_0,size_ro_table_1,size_ro_table_2};
externref (*get_attached_tree_functions[]) (void) = {get_attached_tree_ro_table_0,get_attached_tree_ro_table_1,get_attached_tree_ro_table_2};
void (*attach_tree_functions[]) (externref) = {attach_tree_ro_table_0,attach_tree_ro_table_1,attach_tree_ro_table_2};

// rw table function arrays 
externref (*get_rw_table_functions[]) (int32_t) = {get_rw_table_0,get_rw_table_1,get_rw_table_2};
int32_t (*size_rw_table_functions[])(void) = {size_rw_table_0,size_rw_table_1,size_rw_table_2};
int32_t (*grow_rw_table_functions[]) (int32_t, externref) = {grow_rw_table_0,grow_rw_table_1,grow_rw_table_2};
void (*set_rw_table_functions[]) (int32_t, externref) = {set_rw_table_0,set_rw_table_1,set_rw_table_2};
externref (*create_tree_functions[]) (int32_t) = {create_tree_rw_table_0,create_tree_rw_table_1,create_tree_rw_table_2};

// ro mem function arrays 
int32_t (*get_i32_ro_mem_functions[]) (int32_t) = {get_i32_ro_mem_0,get_i32_ro_mem_1,get_i32_ro_mem_2};
int32_t (*get_i8_ro_mem_functions[]) (int32_t) = {get_i8_ro_mem_0,get_i8_ro_mem_1,get_i8_ro_mem_2};
int32_t (*size_ro_mem_functions[])(void) = {size_ro_mem_0,size_ro_mem_1,size_ro_mem_2};
externref (*get_attached_blob_functions[]) (void) = {get_attached_blob_ro_mem_0,get_attached_blob_ro_mem_1,get_attached_blob_ro_mem_2};
void (*attach_blob_functions[]) (externref) = {attach_blob_ro_mem_0,attach_blob_ro_mem_1,attach_blob_ro_mem_2};

// rw mem function arrays 
int32_t (*get_i32_rw_mem_functions[]) (int32_t) = {get_i32_rw_mem_0,get_i32_rw_mem_1,get_i32_rw_mem_2};
int32_t (*get_i8_rw_mem_functions[]) (int32_t) = {get_i8_rw_mem_0,get_i8_rw_mem_1,get_i8_rw_mem_2};
int32_t (*size_rw_mem_functions[])(void) = {size_rw_mem_0,size_rw_mem_1,size_rw_mem_2};
int32_t (*grow_rw_mem_functions[]) (int32_t) = {grow_rw_mem_0,grow_rw_mem_1,grow_rw_mem_2};
void (*set_i32_rw_mem_functions[]) (int32_t, int32_t) = {set_i32_rw_mem_0,set_i32_rw_mem_1,set_i32_rw_mem_2};
void (*set_i8_rw_mem_functions[]) (int32_t, int32_t) = {set_i8_rw_mem_0,set_i8_rw_mem_1,set_i8_rw_mem_2};
externref (*create_blob_functions[]) (int32_t) = {create_blob_rw_mem_0,create_blob_rw_mem_1,create_blob_rw_mem_2};
