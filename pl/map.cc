...
void set_rw_table_0( int32_t index, externref pointer )
  __attribute__( ( import_module( "vector" ), import_name( "set_rw_table_0" ) ) );
int32_t grow_rw_table_0( int32_t size, externref pointer )
  __attribute__( ( import_module( "vector" ), import_name( "grow_rw_table_0" ) ) );
...
void set_rw_table_1( int32_t index, externref pointer )
  __attribute__( ( import_module( "vector" ), import_name( "set_rw_table_1" ) ) );
...
externref get_ro_table_0( int32_t index )
  __attribute__( ( import_module( "vector" ), import_name( "get_ro_table_0" ) ) );

// rw_mem_0
int32_t grow_rw_mem_0( int32_t size )
  __attribute__( ( import_module( "vector" ), import_name( "grow_rw_mem_0" ) ) );
void set_rw_mem_0( int32_t index, int32_t val )
  __attribute__( ( import_module( "vector" ), import_name( "set_rw_mem_0" ) ) );
externref create_blob_rw_mem_0( int32_t size )
  __attribute__( ( import_module( "fixpoint" ), import_name( "create_blob_rw_mem_0" ) ) );

// ro_mem_0
int32_t get_ro_mem_0( int32_t ) __attribute__( ( import_module( "vector" ), import_name( "get_ro_mem_0" ) ) );
