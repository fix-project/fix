...
static void w2c__fixpoint_apply(Z_addblob_module_instance_t* module_instance) {
  ...
  w2c_i1 = 2u;
  w2c_i2 = 1u;
  Z_addblob_Z_env_Z_get_tree_entry(module_instance->Z_env_module_instance, w2c_i0, w2c_i1, w2c_i2);
  w2c_i0 = 0u;
  w2c_i1 = 3u;
  w2c_i2 = 2u;
  Z_addblob_Z_env_Z_get_tree_entry(module_instance->Z_env_module_instance, w2c_i0, w2c_i1, w2c_i2);
  ...
  w2c_i1 = 4u;
  w2c_i2 = 0u;
  Z_addblob_Z_env_Z_freeze_blob(module_instance->Z_env_module_instance, w2c_i0, w2c_i1, w2c_i2);
  w2c_i0 = 0u;
  Z_addblob_Z_env_Z_designate_output(module_instance->Z_env_module_instance, w2c_i0);
  FUNC_EPILOGUE;
}
...
void Z_addblob_Z__fixpoint_apply(Z_addblob_module_instance_t* module_instance) {
  return w2c__fixpoint_apply(module_instance);
}
...
void Z_addblob_init(Z_addblob_module_instance_t* module_instance, struct Z_env_module_instance_t* Z_env_module_instance) {
  init_instance_import(module_instance, Z_env_module_instance);
