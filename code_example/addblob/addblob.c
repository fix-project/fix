...
static void w2c__fixpoint_apply(Z_addblob_module_instance_t *);

static void w2c__fixpoint_apply(Z_addblob_module_instance_t *module_instance) {
  FUNC_PROLOGUE;
  ...
  w2c_i0 = 1u;
  w2c_i1 = 0u;
  (*WASM_RT_ADD_PREFIX(Z_envZ_attach_blobZ_vii))(module_instance, w2c_i0, w2c_i1);
  w2c_i0 = 2u;
  w2c_i1 = 1u;
  (*WASM_RT_ADD_PREFIX(Z_envZ_attach_blobZ_vii))(module_instance, w2c_i0, w2c_i1);
  w2c_i0 = 1u;
  ...
  w2c_i0 = 0u;
  (*WASM_RT_ADD_PREFIX(Z_envZ_designate_outputZ_vi))(module_instance, w2c_i0);
  FUNC_EPILOGUE;
}

static void init_globals(Z_addblob_module_instance_t *module_instance) {
}
...
static void init_table(Z_addblob_module_instance_t *module_instance) {
  uint32_t offset;
  wasm_rt_allocate_table(&module_instance->w2c_T0, 1, 1);
}
/* export: '_fixpoint_apply' */
void (*WASM_RT_ADD_PREFIX(Z__fixpoint_applyZ_vv))(Z_addblob_module_instance_t *) = (&w2c__fixpoint_apply);
/* export: 'ro_mem_0' */
wasm_rt_memory_t* WASM_RT_ADD_PREFIX(Z_ro_mem_0)(Z_addblob_module_instance_t *module_instance){
  return &module_instance->w2c_ro_mem_0;
}

/* export: 'ro_mem_1' */
wasm_rt_memory_t* WASM_RT_ADD_PREFIX(Z_ro_mem_1)(Z_addblob_module_instance_t *module_instance){
  return &module_instance->w2c_ro_mem_1;
}

/* export: 'rw_mem_0' */
wasm_rt_memory_t* WASM_RT_ADD_PREFIX(Z_rw_mem_0)(Z_addblob_module_instance_t *module_instance){
  return &module_instance->w2c_rw_mem_0;
}


void WASM_RT_ADD_PREFIX(init)(Z_addblob_module_instance_t *module_instance) {
  init_func_types();
