...
const static int NUM_RO_MEM = 8;
const static int NUM_RO_TABLE = 8;
const static int NUM_RW_MEM = 8;
const static int NUM_RW_TABLE = 8;
...
int32_t get_i8_ro_mem_4( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_ro_mem_4" ) ) );
...
int32_t get_i8_ro_mem_5( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_ro_mem_5" ) ) );
...
int32_t get_i8_ro_mem_6( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_ro_mem_6" ) ) );
...
int32_t get_i8_ro_mem_7( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_ro_mem_7" ) ) );
...
void set_i8_rw_mem_3( int32_t index, int32_t val )
  __attribute__( ( import_module( "fixpoint_storage" ), import_name( "set_i8_rw_mem_3" ) ) );
int32_t get_i32_rw_mem_3( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i32_rw_mem_3" ) ) );
int32_t get_i8_rw_mem_3( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_rw_mem_3" ) ) );
int32_t grow_rw_mem_3( int32_t size )
...
void set_i8_rw_mem_4( int32_t index, int32_t val )
  __attribute__( ( import_module( "fixpoint_storage" ), import_name( "set_i8_rw_mem_4" ) ) );
int32_t get_i32_rw_mem_4( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i32_rw_mem_4" ) ) );
int32_t get_i8_rw_mem_4( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_rw_mem_4" ) ) );
int32_t grow_rw_mem_4( int32_t size )
...
void set_i8_rw_mem_5( int32_t index, int32_t val )
  __attribute__( ( import_module( "fixpoint_storage" ), import_name( "set_i8_rw_mem_5" ) ) );
int32_t get_i32_rw_mem_5( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i32_rw_mem_5" ) ) );
int32_t get_i8_rw_mem_5( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_rw_mem_5" ) ) );
int32_t grow_rw_mem_5( int32_t size )
...
void set_i8_rw_mem_6( int32_t index, int32_t val )
  __attribute__( ( import_module( "fixpoint_storage" ), import_name( "set_i8_rw_mem_6" ) ) );
int32_t get_i32_rw_mem_6( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i32_rw_mem_6" ) ) );
int32_t get_i8_rw_mem_6( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_rw_mem_6" ) ) );
int32_t grow_rw_mem_6( int32_t size )
...
void set_i8_rw_mem_7( int32_t index, int32_t val )
  __attribute__( ( import_module( "fixpoint_storage" ), import_name( "set_i8_rw_mem_7" ) ) );
int32_t get_i32_rw_mem_7( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i32_rw_mem_7" ) ) );
int32_t get_i8_rw_mem_7( int32_t )     __attribute__( ( import_module( "fixpoint_storage" ), import_name( "get_i8_rw_mem_7" ) ) );
int32_t grow_rw_mem_7( int32_t size )
...
static externref (*get_rw_table_functions[]) (int32_t) = {get_rw_table_0,get_rw_table_1,get_rw_table_2,get_rw_table_3,get_rw_table_4,get_rw_table_5,get_rw_table_7,get_rw_table_7};
static int32_t (*size_rw_table_functions[])(void) = {size_rw_table_0,size_rw_table_1,size_rw_table_2,size_rw_table_3,size_rw_table_4,size_rw_table_5,size_rw_table_6,size_rw_table_7};
static int32_t (*grow_rw_table_functions[]) (int32_t, externref) = {grow_rw_table_0,grow_rw_table_1,grow_rw_table_2,grow_rw_table_3,grow_rw_table_4,grow_rw_table_5,grow_rw_table_6,grow_rw_table_7};
static void (*set_rw_table_functions[]) (int32_t, externref) = {set_rw_table_0,set_rw_table_1,set_rw_table_2,set_rw_table_3,set_rw_table_4,set_rw_table_5,set_rw_table_6,set_rw_table_7};
static externref (*create_tree_functions[]) (int32_t) = {create_tree_rw_table_0,create_tree_rw_table_1,create_tree_rw_table_2,create_tree_rw_table_3,create_tree_rw_table_4,create_tree_rw_table_5,create_tree_rw_table_6,create_tree_rw_table_7};

// ro mem function arrays 
static int32_t (*get_i32_ro_mem_functions[]) (int32_t) = {get_i32_ro_mem_0,get_i32_ro_mem_1,get_i32_ro_mem_2,get_i32_ro_mem_3,get_i32_ro_mem_4,get_i32_ro_mem_5,get_i32_ro_mem_6,get_i32_ro_mem_7};
static int32_t (*get_i8_ro_mem_functions[]) (int32_t) = {get_i8_ro_mem_0,get_i8_ro_mem_1,get_i8_ro_mem_2,get_i8_ro_mem_3,get_i8_ro_mem_4,get_i8_ro_mem_5,get_i8_ro_mem_6,get_i8_ro_mem_7};
static int32_t (*byte_size_ro_mem_functions[])(void) = {byte_size_ro_mem_0,byte_size_ro_mem_1,byte_size_ro_mem_2,byte_size_ro_mem_3,byte_size_ro_mem_4,byte_size_ro_mem_5,byte_size_ro_mem_6,byte_size_ro_mem_7};
static externref (*get_attached_blob_functions[]) (void) = {get_attached_blob_ro_mem_0,get_attached_blob_ro_mem_1,get_attached_blob_ro_mem_2,get_attached_blob_ro_mem_3,get_attached_blob_ro_mem_4,get_attached_blob_ro_mem_5,get_attached_blob_ro_mem_6,get_attached_blob_ro_mem_7};
static void (*attach_blob_functions[]) (externref) = {attach_blob_ro_mem_0,attach_blob_ro_mem_1,attach_blob_ro_mem_2,attach_blob_ro_mem_3,attach_blob_ro_mem_4,attach_blob_ro_mem_5,attach_blob_ro_mem_6,attach_blob_ro_mem_7};

// rw mem function arrays 
static int32_t (*get_i32_rw_mem_functions[]) (int32_t) = {get_i32_rw_mem_0,get_i32_rw_mem_1,get_i32_rw_mem_2,get_i32_rw_mem_3,get_i32_rw_mem_4,get_i32_rw_mem_5,get_i32_rw_mem_6,get_i32_rw_mem_7};
static int32_t (*get_i8_rw_mem_functions[]) (int32_t) = {get_i8_rw_mem_0,get_i8_rw_mem_1,get_i8_rw_mem_2,get_i8_rw_mem_3,get_i8_rw_mem_4,get_i8_rw_mem_5,get_i8_rw_mem_6,get_i8_rw_mem_7};
static int32_t (*page_size_rw_mem_functions[])(void) = {page_size_rw_mem_0,page_size_rw_mem_1,page_size_rw_mem_2,page_size_rw_mem_3,page_size_rw_mem_4,page_size_rw_mem_5,page_size_rw_mem_6,page_size_rw_mem_7};
static int32_t (*grow_rw_mem_functions[]) (int32_t) = {grow_rw_mem_0,grow_rw_mem_1,grow_rw_mem_2,grow_rw_mem_3,grow_rw_mem_4,grow_rw_mem_5,grow_rw_mem_6,grow_rw_mem_7};
static void (*set_i32_rw_mem_functions[]) (int32_t, int32_t) = {set_i32_rw_mem_0,set_i32_rw_mem_1,set_i32_rw_mem_2,set_i32_rw_mem_3,set_i32_rw_mem_4,set_i32_rw_mem_5,set_i32_rw_mem_6,set_i32_rw_mem_7};
static void (*set_i8_rw_mem_functions[]) (int32_t, int32_t) = {set_i8_rw_mem_0,set_i8_rw_mem_1,set_i8_rw_mem_2,set_i8_rw_mem_3,set_i8_rw_mem_4,set_i8_rw_mem_5,set_i8_rw_mem_6,set_i8_rw_mem_7};
static externref (*create_blob_functions[]) (int32_t) = {create_blob_rw_mem_0,create_blob_rw_mem_1,create_blob_rw_mem_2,create_blob_rw_mem_3,create_blob_rw_mem_4,create_blob_rw_mem_5,create_blob_rw_mem_6,create_blob_rw_mem_7};
