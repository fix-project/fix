...
# c function lists
C_LIST_TABLE_GET = 'static externref (*get_{ro_or_rw}_table_functions[]) (int32_t) = {list};\n'
C_LIST_TABLE_SET = 'static void (*set_rw_table_functions[]) (int32_t, externref) = {list};\n'
C_LIST_TABLE_GROW = 'static int32_t (*grow_rw_table_functions[]) (int32_t, externref) = {list};\n'
