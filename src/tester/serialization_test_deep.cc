...
int main()
{
  ...
  Name file_permission_blob = runtime.add_blob( string_view( file_permission ) ); // all file dirents will have the same permissions
  Name dir_permission_blob = runtime.add_blob( string_view( dir_permission ) ); // all dir dirents will have the same permissions
  ...
  Name directory_c_dirent_name = runtime.add_tree( span_view<Name>( directory_c_dirent.data(), directory_c_dirent.size() ) );
  ...
  Name hello_file_1_dirent_name = runtime.add_tree( span_view<Name>( hello_file_1_dirent.data(), hello_file_1_dirent.size() ) );
  ...
  Name b_directory_1_dirent_name = runtime.add_tree( span_view<Name>( b_directory_1_dirent.data(), b_directory_1_dirent.size() ) );
  ...
  Name directory_b_dirent_name = runtime.add_tree( span_view<Name>( directory_b_dirent.data(), directory_b_dirent.size() ));
  ...
  Name directory_a_dirent_name = runtime.add_tree( span_view<Name>( directory_a_dirent.data(), directory_a_dirent.size() ) );
