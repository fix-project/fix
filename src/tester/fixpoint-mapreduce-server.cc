...
int main( int argc, char* argv[] )
{
  ...
  auto mapreduce = server->get_rt()
                     .labeled( "mapreduce" )
                     .unwrap<Expression>()
                     .unwrap<Object>()
                     .unwrap<Value>()
                     .unwrap<ValueTree>();
  auto mapper = server->get_rt()
                  .labeled( "count-words" )
                  .unwrap<Expression>()
                  .unwrap<Object>()
                  .unwrap<Value>()
                  .unwrap<ValueTree>();
  auto reducer = server->get_rt()
                   .labeled( "merge-counts" )
                   .unwrap<Expression>()
                   .unwrap<Object>()
                   .unwrap<Value>()
                   .unwrap<ValueTree>();
  server->get_rt().get( mapreduce );
  server->get_rt().get( mapper );
  server->get_rt().get( reducer );
