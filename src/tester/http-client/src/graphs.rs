    ...
    pub fn view(
        ...
        egui::Window::new("Ancestry Tree")
            ...
            .show(ctx, |ui| {
                ...
                if let Some((coords, closest_elem)) = hovered_elem {
                    self.ancestry
                        .handle_nearby_click(ui, coords, closest_elem, |index, handle| {
                            http::get_parents(
                                client.clone(),
                                ctx.clone(),
                                index,
        ...
        egui::Window::new("Progress Tree")
            ...
            .show(ctx, |ui| {
                ...
                if let Some((coords, closest_elem)) = hovered_elem {
                    self.progress.handle_nearby_click(
                        ui,
                        coords,
                        closest_elem,
                        |index, handle, operation| {
                            http::get_child(
                                client.clone(),
                                ctx.clone(),
                                index,
