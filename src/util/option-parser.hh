...
public:
  ...
  // Helper functions.
  void AddOption( char short_name, const char* long_name, const char* help, const NullCallback& );
  void AddOption( const char* long_name, const char* help, const NullCallback& );
  void AddOption( char short_name, const char* long_name, const char* metavar, const char* help, const Callback& );

private:
  static int Match( const char* s, const std::string& full, bool has_argument );
  void ParseError( std::string error_msg );
