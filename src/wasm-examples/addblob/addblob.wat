(module
  ...
  (import "env" "ro_table_0" (table $ro_table 0 externref))
  (table $ro_handles 16 externref)
  (table $rw_handles 16 externref)
  (func (export "_fixpoint_apply") (result externref)
    (call $attach_tree (table.get $ro_handles (i32.const 0)) (i32.const 0))
  ...
  (export "ro_handles" (table $ro_handles))
) 
