(module
  ...
  (import "env" "attach_tree_ro_table_0" (func $attach_tree_ro_tree_0 (type 0)))
  (import "env" "attach_blob_ro_mem_0" (func $attach_blob_ro_mem_0 (type 0)))
  (import "env" "attach_blob_ro_mem_1" (func $attach_blob_ro_mem_1 (type 0)))
  (import "env" "detach_mem_rw_mem_0" (func $detach_mem_rw_mem_0 (type 2)))
  (import "env" "freeze_blob" (func $freeze_blob (type 1)))
  (memory $memzero 0)
  (memory $memone 0)
  (memory $memtwo 1)
