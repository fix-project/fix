...
inline thread_local Runner::BlobMap curr_minrepo_blobs;
inline thread_local Runner::TreeMap curr_minrepo_trees;
...
public:
  ...
  virtual std::optional<Handle<Object>> apply( Handle<ObjectTree> handle,
                                               [[maybe_unused]] BlobMap&& minrepo_blobs,
                                               TreeMap&& minrepo_trees ) override
  {
    ...
    auto combination = minrepo_trees.at( handle::upcast( handle ) );
...
public:
                                               ...
                                               TreeMap&& minrepo_trees ) override
  {
    ...
    curr_minrepo_blobs = std::move( minrepo_blobs );
    curr_minrepo_trees = std::move( minrepo_trees );
